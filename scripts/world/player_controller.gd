...
## Até 2026-09-01 o corpo teve, por um dia, um sistema de empuxo aqui — o mar
## seguia com profundidade de verdade (`MapTerrain.SEA_HEIGHT` a 6,6 m da
## terra), e sem flutuação o jogador caía nele e ficava preso: a rampa era
## mais íngreme que os 45° que o `CharacterBody3D` aceita como piso pra
## escalar de volta andando. Removido no mesmo dia — a correção final não foi
## fazer o corpo boiar, foi encolher o mar até não ter profundidade que
## justifique afundar (ver "O mar é raso de propósito" em `MapTerrain`). O
